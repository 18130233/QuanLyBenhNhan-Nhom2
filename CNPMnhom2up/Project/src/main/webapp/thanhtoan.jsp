...
<header class="header">Màn Hình Thanh Toán</header>
    <div class="container">
		...
		action="http://localhost:8686/Project/searchID?action=searchID2" method="post">
   ...
   if(tienSu==null) tienSu="";
        ...
        <div class="column__right">
            <div class="column__right-frames1">
                ...
                <form class="formLogin"
		action="http://localhost:8686/Project/searchID?action=Inhoadon" method="post">
            ...
            <form class="formLogin"
		action="http://localhost:8686/Project/searchID?action=Capnhatthanhtoan" method="post">
                <div class="frames4-1">
                ...
                <div class="frames4-2">
                    <div class="frames4-2-row1" >
                        ...
                        <input type="text" name="" id="" style="margin-left: 40px;" value="<%=tongTien%>" >
                    </div>
